...
void MediaApp::onStateChanged()
{
    ...
    m_captureButton->setEnabled(newState != QGst::StatePlaying);
...
void MediaApp::showControls(bool show)
{
    ...
    m_captureButton->setVisible(show);
...
void MediaApp::createUI(QBoxLayout *appLayout)
{
    ...
    m_captureButton = initButton(QStyle::SP_DriveDVDIcon, tr("Capture"),
                                 m_player, SLOT(capture()), btnLayout);
